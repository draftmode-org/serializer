...
use Terrazza\Component\Serializer\Denormalizer\ArrayDataDenormalizer;
...
class JsonArrayDataSerializer implements SerializerInterface {
    private DecoderInterface $decoder;
    private DenormalizerInterface $denormalizer;

    public function __construct() {
        $this->decoder                              = new JsonDecoder();
        $this->denormalizer                         = new ArrayDataDenormalizer(
